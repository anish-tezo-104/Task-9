...
public partial class EMS
{
    ...
    private static EMSContext _context;
    ...
    static EMS()
    {
        ...
        _context = new EMSContext(_connectionString);
        _dropdownDal = new DropdownDAL(_context, _logger, _connectionString);
        _dropdownBal = new DropdownBAL(_dropdownDal);
        _employeeDal = new EmployeeDAL(_context, _logger, _connectionString);
        _roleDal = new RoleDAL(_context, _logger, _connectionString);
    ...
    public static void Main(string[] args)
    {
        ...
        // using var context = new EMSContext(_connectionString);

        var rootCommand = new RootCommand("Employee Management System");
        HandleCommandArgs(args, rootCommand);
    }
